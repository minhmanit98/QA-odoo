...
class MailBot(models.AbstractModel):
    _inherit = 'mail.bot'
    server_bot = fields.Char("Server Bot", default="http://chatbotrouter.herokuapp.com/send_chat.php?id=odoo&noidung=")
    ...
    def _get_answer(self, record, body, values, command=False):
        ...
        if self._is_bot_in_private_channel(record):
            ...
            elif odoobot_state == "haribot":
                return _(requests.get("http://chatbotrouter.herokuapp.com/send_chat.php?id=odoo&noidung=" + body).text)
            else:
                #repeat question
